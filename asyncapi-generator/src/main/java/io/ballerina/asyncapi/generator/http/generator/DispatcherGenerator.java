...
public class DispatcherGenerator {
    ...
    public String generate() throws GeneratorException {
        ...
        // log is always imported (unconditional MATCH_LEVEL_1/2 diagnostic trace logging happens
        // regardless of webhookAuthConfig); crypto/time are only needed when auth/freshness apply.
